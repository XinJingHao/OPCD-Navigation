...
class Env_4_OkayPlan():
    ...
    def __init__(self, opt):
        ...
        self.dilation = self.D_FML_AGV / 2 + 0.2 # bounding box的膨胀: 半径+余量
    ...
    def reset(self, start, target) -> dict:
        ...
        self._Set_object_pose(obj_name='fml_robot_0', x=start[0], y=start[1], z=0) # 重置被控小车位置
